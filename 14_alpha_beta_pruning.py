...
def alpha_beta_pruning(game, depth, alpha, beta, maximizing):
    # Base cases
    if game.current_winner == 'X':
        return 1, None  # score, move
    elif game.current_winner == 'O':
        return -1, None
    elif not game.empty_squares() or depth == 0:
        return 0, None
...
def play(game):
    ...
    while game.empty_squares():
        ...
        # O is AI player with alpha-beta pruning
        _, ai_move = alpha_beta_pruning(game, 9, float('-inf'), float('inf'), False)
